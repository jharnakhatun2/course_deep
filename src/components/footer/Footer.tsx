...
const Footer = () => {
  const headerClass = "font-bold tracking-wide pb-2 border-b border-zinc-600 uppercase text-sm";
      ...
      <div className="space-y-6 grid sm:grid-cols-4 gap-5 lg:gap-10">
        ...
        <div className="">
          ...
          <div className="mt-4 lg:max-w-sm">
            With 20+ years of experience, we deliver expert programming courses for businesses and individuals. Our instructors bring real-world expertise to help you master coding, project structuring, and building scalable applications.
          </div>
          <Button url="/courses" className="border border-zinc-500 hover:text-white hover:bg-stone-400 hover:border-stone-400 mt-4 text-[12px]">Start Learning Now</Button>
        </div>
        {/* Other cols */}
