...
const Testimonial: React.FC = () => {
  ...
  useEffect(() => {
    if (contentRef.current) {
      setHeight(isOpen ? `${contentRef.current.scrollHeight}px` : "700px");
    }
  }, [isOpen]);
    ...
    <section className="text-gray-300 bg-gray-900 py-8 lg:py-12" id="reviews">
      <div className="max-w-7xl mx-auto px-6 md:px-12 xl:px-4">
        ...
        >
          <div
            ref={contentRef}
            className="md:columns-2 lg:columns-3 gap-4 space-y-4 py-8 sm:py-10"
          >
            {/* Card 1 */}
            <div className="backdrop-blur-lg aspect-auto p-8 border rounded-3xl bg-gray-800 border-gray-700 shadow-2xl">
              ...
              <p className="mt-8">
                “The React.js course was a game-changer. The instructor
                explained complex concepts clearly and provided hands-on
                projects that boosted my confidence. Within two weeks of
                finishing, I landed my first freelance project. Highly
                recommended for anyone looking to master React and build
                real-world projects!”
              </p>
            </div>
            ...
            <div className="aspect-auto p-8 border border-gray-700 rounded-3xl bg-gray-800 shadow-2xl shadow-gray-600/10 dark:shadow-none">
              ...
              <p className="mt-8">
                “I’ve tried other platforms before, but this LMS feels
                different. The projects are practical, and the feedback system
                really helped me improve my JavaScript skills.”
              </p>
            </div>
            ...
            <div className="aspect-auto p-8 border border-gray-700 rounded-3xl bg-gray-800 shadow-2xl shadow-gray-600/10">
              ...
              <p className="mt-8">
                “Short, clear, and practical! The Git & GitHub crash course
                saved me hours of confusion. Now I finally collaborate with my
                teammates without messing up branches.”
              </p>
            </div>
            ...
            <div className="aspect-auto p-8 border border-gray-700 rounded-3xl bg-gray-800 shadow-2xl shadow-gray-600/10 dark:shadow-none">
              ...
              <p className="mt-8">
                ...
                full-stack developer roles. The combination of tutorials,
                quizzes, and coding kept me motivated. The MongoDB section was
                super clear!”
              </p>
            </div>
            ...
            <div className="aspect-auto p-8 border border-gray-700 rounded-3xl bg-gray-800 shadow-2xl shadow-gray-600/10 dark:shadow-none">
              ...
              <p className="mt-8">
                “The digital marketing strategies I learned helped me increase
                my company's online presence and sales. The course was
