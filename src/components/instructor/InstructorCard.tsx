...
const InstructorCard: React.FC<InstructorCardProps> = ({
  ...
  return (
			<div className="my-12 flex flex-col justify-center items-center transition-shadow transition-smooth bg-white/10 backdrop-blur-lg w-full text-center rounded-md sm:w-42 md:w-72 lg:w-70 xl:w-64 border border-white/30">
				<img alt={name} className="self-center flex-shrink-0 w-24 h-24 -mt-12 bg-center bg-cover rounded-full bg-gray-500 shadow-[0_0_5px_#ffffff]" src={image} />
				<div className="flex-1 my-4">
					<p className="text-xl font-semibold leading-snug">{name}</p>
					<p>{role}</p>
				</div>
				<div className="flex items-center justify-center p-3 space-x-3 border-t-2">
					<a rel="noopener noreferrer" href="#" title="Email" className="text-gray-50 hover:text-yellow-500">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
							<path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
							<path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
						</svg>
					</a>
					<a rel="noopener noreferrer" href={twitterProfile} title="Twitter" className="text-gray-50 hover:text-yellow-500">
					...
					<a rel="noopener noreferrer" href={linkedinProfile} title="LinkedIn" className="text-gray-50 hover:text-yellow-500">
					...
					<a rel="noopener noreferrer" href={facebookProfile} title="GitHub" className="text-gray-50 hover:text-yellow-500">
						<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-5 h-5">
